...
with open('lineage.csv', newline='') as csvfile:
    featurereader = csv.DictReader(csvfile)
    for row in featurereader:
               print(row)
               print(row['FEATURE DATATYPE'])
               print(row['FEATURE NAME'])
               #featureslist.append(Feature(name=row['FEATURE NAME'], dtype=ValueType.row['FEATURE DATATYPiiiE']))
               featureslist.append(Feature(name=row['FEATURE NAME'], dtype=ValueType.FLOAT))
